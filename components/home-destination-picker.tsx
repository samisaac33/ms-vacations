      ...
      {destinations.map((destination) => (
        ...
        >
          <div className="relative aspect-[16/10]">
            ...
            <span className="absolute left-4 top-4 rounded-full bg-surface/90 px-3 py-1 text-[11px] font-bold uppercase tracking-wide text-ocean shadow-sm">
          ...
          <div className="absolute inset-x-0 bottom-0 flex items-end justify-between gap-4 p-4 text-white sm:p-5">
            ...
            <span
              aria-hidden
              className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-surface text-ocean shadow-md transition-transform group-hover:scale-105"
            >
