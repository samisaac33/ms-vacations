  ...
  return (
    <header className="sticky top-0 z-50 border-b border-sand-dark/80 bg-sand/95 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3 sm:px-6">
        <Link
          href="/"
          className="shrink-0 text-lg font-semibold tracking-tight text-ink transition-colors hover:text-ocean"
        >
          {siteConfig.name}
        </Link>
        ...
        <div className="flex items-center gap-2">
          {wa && (
            <a
              ...
              className="hidden rounded-lg bg-ocean px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-ocean-dark sm:inline-flex"
            >
              WhatsApp
            </a>
          )}
