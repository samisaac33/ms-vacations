      ...
      <div className="mx-auto flex h-[72px] max-w-7xl items-center justify-between gap-4 px-6 md:px-10">
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            ...
            className="hidden items-center gap-2 rounded-xl bg-primary px-4 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-primary-hover sm:inline-flex"
          >
            <WhatsAppIcon />
            WhatsApp
          </a>
