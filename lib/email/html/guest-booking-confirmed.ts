...
export function buildGuestBookingConfirmedHtml(ctx: BookingEmailContext): string {
  ...
  const bodyHtml = `
          <tr>
            <td style="padding:32px 28px 8px;">
              <p style="margin:0 0 8px;font-size:14px;color:${COLORS.muted};text-transform:uppercase;letter-spacing:0.06em;">Confirmación</p>
              <h1 style="margin:0 0 8px;font-size:26px;font-weight:700;color:${COLORS.ink};line-height:1.3;">Tu reserva está confirmada</h1>
  ...
  return emailShell({
    pageTitle: "Tu reserva está confirmada",
